...
<table class="table">
  ...
  <tbody>
    ...
    ?>
    <tr class="<?= $message['signaled'] == true ? 'table-warning' : '' ; ?>">
      ...
      <td scope="col">
        <select onchange="moveToCat(<?= $message['id_m'] ; ?>, 'all')" id="newCat<?= $message['id_m'] ; ?>">
          <?php
      ...
      <td scope="col">
        ...
        <button type="button" class="btn btn-success btn-sm" onclick="unsignal(<?= $message['id_m'] ; ?>)">Désignaler</button>
        <?php } else { ?>
        <button type="button" class="btn btn-outline-success btn-sm">√</button>
        <?php } ?>
      </td>
      <td scope="col">
        <button type="button" class="btn btn-outline-danger btn-sm" onclick="dropMessage(<?= $message['id_m'] ; ?>, 'all')">Supprimer</button>
      </td>
    </tr>
    <?php
    }
