        ...
        <tbody>
            <?php foreach ($types as $key => $type) { ?>
                <tr id="component-type-row-<?php echo $type['id_t']; ?>">
                    ...
                    <td>
                        <a href="/admin/hardware/edit_type.php?id=<?php echo $type['id_t']; ?>" class="btn btn-sm btn-primary">Voir le type</a>
                        <a href="#" class="btn btn-sm btn-danger" onclick="remove_type(<?php echo $type['id_t']; ?>);">Supprimer</a>
                    </td>
